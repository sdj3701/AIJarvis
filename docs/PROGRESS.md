...
> 현재 상태: Phase 1 P1-01~P1-03 완료, 로컬 대화 저장 기반 확보
> 현재 Phase: Phase 1 (다음 P1-04 프롬프트·컨텍스트 예산)
...
| 1 대화 | in_progress | [Phase 1](./phase-01-chat/README.md) | — | P1-01~P1-03 완료, P1-04 대기 |
