...
> 현재 상태: Phase 1 P1-01~P1-04 완료, 버전 프롬프트·16K 컨텍스트 압축 확보
> 현재 Phase: Phase 1 (다음 P1-05 비용 예산)
...
| 1 대화 | in_progress | [Phase 1](./phase-01-chat/README.md) | — | P1-01~P1-04 완료, P1-05 대기 |
