...
이 폴더는 모든 Phase가 공통으로 참조하는 문서를 모은다.

- [요구사항 추적표](./TRACEABILITY.md): 제품 요구 → 설계 → 데이터 → 테스트 연결
- [문서 변경 규칙](./DOCUMENTATION_RULES.md): 어떤 문서를 먼저 수정해야 하는지
- [위협 모델](./THREAT_MODEL.md): 자산·신뢰 경계·공격·통제·검증 상태
